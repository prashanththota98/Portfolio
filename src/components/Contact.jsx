export default function Contact() {
  return (
    <section
      id="contact"
      className="py-20 px-4 sm:px-6 lg:px-16 bg-linear-to-r from-gray-900 via-gray-800 to-gray-700 text-white text-center"
    >
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
        <a
          ...
          className="px-6 py-3 bg-cyan-400 text-gray-900 rounded-full hover:bg-cyan-500 transition"
        >
          Email Me
        </a>
        <a
